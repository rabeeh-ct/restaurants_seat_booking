...
class _TempScreenState extends State<TempScreen> {
  PageController pageviewctr=PageController(initialPage: 0,);
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GestureDetector(onHorizontalDragCancel: () {
        print('object');
        setState(() {
          pageviewctr.animateToPage(0, duration: Duration(seconds: 1), curve: Curves.bounceIn);
        });
      },
        child: PageView(
